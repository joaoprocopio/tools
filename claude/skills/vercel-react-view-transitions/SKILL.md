...
description: 'React View Transition API: `<ViewTransition>`, `addTransitionType`, and CSS view transition pseudo-elements. Use when animating route changes, shared elements, component enter/exit, or list reorder in React or Next.js, or when the user mentions view transitions or `startViewTransition`.'
license: MIT
metadata:
  author: vercel
  version: "1.0.0"
